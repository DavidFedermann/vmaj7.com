...
;(function( $ )
{
    $.GsapCarousel = function( el, options )
    {
        ...
        base.init = function()
        {
            ...
            //      Default to container's width & height
            if ( !base.options.w )
                base.options.w = base.$el.parent().width();
            if ( !base.options.h )
                base.options.h = base.$el.parent().height();
            
            //      debug
            //console.log( base.options );
            
            //      Visibility (prevent onload 'flash' glitch)
            base.$el.css( 'opacity', 0 ).css( 'visibility', 'visible' );
            TweenLite.to( base.$el, 3, { opacity:1, ease:Expo.easeOut });
            ...
            if ( base.indicators.length )
            {
                ...
                if ( base.options.pause_on_hover )
                {
        ...
        base.slide_to = function( pos )
        {
            ...
            //console.log( "i_active_item = " + base.i_active );
            ...
            for ( i = 0; i < base.items.length; i++ )
            {
                ...
                else
                {
                    ...
                    //      update 2013/10/20 11:53:24 - position without transition, since we're out of sight
                    no_transition = true;
            ...
            //      Custom callback
            if ( base.options.custom_slide_callback && $.isFunction( base.options.custom_slide_callback ))
                base.options.custom_slide_callback( base );
        };
    ...
    $.GsapCarousel.defaultOptions = {
        ...
        //      Defaults to container's width & height
        //w: 400,
        //h: 200,
        
        //      Support for custom callback @ every slide
        //custom_slide_callback: function( base ){},
        
        //      easing for Tweens
        ease: Expo.easeInOut,
        
        //      Enable cycle pausing while mouse hovers carousel (or carousel indicators)
        pause_on_hover: true,
